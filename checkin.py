...
class Check:
    ...
    def main(self):
        ...
        try:
            ...
            requests.post(url=f"https://sctapi.ftqq.com/{server_chan_subscription_key}.send",
                          data={"text": self.result, "desp": self.info})


if __name__ == '__main__':
    server_chan_subscription_key = "your_subscription_key"
    check = Check(username='username', password='password')
    check.main()
